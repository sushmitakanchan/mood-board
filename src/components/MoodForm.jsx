...
const MoodForm = ({onHandlethoughts, onHandleEmotions, emotion}) => {
  ...
  const senseEmotion = (e) =>{
    e.preventDefault()
    const selectedEmotion = e.currentTarget.id;
    onHandleEmotions(selectedEmotion)
  }
  return (
    <>
      <form>
        ...
        <div className='flex flex-col items-center justify-center gap-2 w-full mt-4 z-10'>
          ...
          <button onClick={senseEmotion}><img src={joyful} alt="" id='Joyful' className='size-50'/></button>
          <button onClick={senseEmotion}><img src={scared} alt="" id='Scared' className='h-30 w-45'/></button>
          <button onClick={senseEmotion}><img src={sad} alt="" id='Sad' className='size-42'/></button>
          <button onClick={senseEmotion}><img src={peaceful} alt="" id='Peaceful' className='size-42'/></button>
          <button onClick={senseEmotion}><img src={powerful} alt="" id='Powerful' className='size-45'/></button>
          <button onClick={senseEmotion}><img src={joyful} alt="" id='Angry' className='size-50'/></button>
          </div>
          <div>
            ...
            {showLogEmotionCard && <LogEmotionCard onClose={()=>setShowLogEmotionCard(false)} onSaveThoughts = {onHandlethoughts} onSaveEmotions={onHandleEmotions} emotion={emotion}/>}
          </div>
        </div>
        </div>
